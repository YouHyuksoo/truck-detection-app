...
export function CommunicationTest({
  ...
  useEffect(() => {
    const loadLogs = async () => {
      ...
      try {
        ...
        const logData = await getCommunicationLogs();
  ...
  const handleWrite = async () => {
    ...
    try {
      ...
      // PLC에 데이터 쓰기
      await writePLCData(address, writeValue, dataType);
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {!device || !isConnected ? (
                  <Alert className="mb-4">
                    ...
                    <AlertDescription>
                      통신 테스트를 하기 전에 먼저 연결 설정 탭에서 PLC를
                      연결하세요.
                    </AlertDescription>
                  </Alert>
                ) : null}
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value={DataType.DWORD}>
                              DWord
                            </SelectItem>
              ...
              <CardFooter className="justify-between">
                <Button
                  variant="outline"
                  onClick={handleRead}
                  disabled={!device || !isConnected || isReading}
                >
                  {isReading ? (
                    <>
                      읽는 중...
                ...
                <Button
                  onClick={handleWrite}
                  disabled={!device || !isConnected || isWriting}
                >
                  {isWriting ? (
                    <>
                      쓰기 중...
